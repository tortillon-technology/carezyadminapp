...
void deleteRecoveryVehicleDialog(BuildContext context,
    {required Function() onDelete}) {
  showDialog(
    context: context,
    barrierColor: HexColor('#DFD5C5').withValues(alpha: 0.56),
    builder: (context) => DeleteRecoveryVehicleDialog(
      onDelete: onDelete,
    ),
  );
}

class DeleteRecoveryVehicleDialog extends StatelessWidget {
  final Function() onDelete;
  const DeleteRecoveryVehicleDialog({super.key, required this.onDelete});
